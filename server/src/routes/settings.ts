...
app.get("/api/settings/opencode/status", async (c) => {
  ...
  return c.json({
    ...
    availability: {
      ...
      cliAvailable: availability.cliAvailable ?? availability.available,
      runAvailable: availability.runAvailable ?? availability.available,
      ...
      runResolutionError: availability.runResolutionError ?? null,
      probeExecutionMode: availability.probeExecutionMode ?? null,
      providerMetadata: availability.providerMetadata ?? {
        hasConfig: false,
        providerCount: 0,
        modelCount: 0,
        authCredentialCount: 0,
        cliCredentialCount: null,
        credentialCount: 0,
      },
      runtimeSource: availability.runtimeSource ?? null,
      bundledRuntime: availability.bundledRuntime ?? null,
      localResolutionError: availability.localResolutionError ?? null,
