...
export function generateProductionListSchemaSnapshot(): SchemaSnapshot {
  return {
    ...
    description:
      ...
      "Each generated line must bind to a complete prompt profile with Audio Profile, Scene, Director's Notes, Sample Context, speakers, and Transcript.",
    rootType: "object",
    fields: [
      {
        name: "schemaVersion",
      ...
      },
      {
        ...
        type: "array",
        required: true,
        description: "Compatibility speaker list aggregated from promptProfiles. Maximum 2 speakers allowed.",
        constraints: ["Maximum 2 speakers", "Each speaker must have unique id", "Must align with promptProfiles[].speakers"],
      },
    ],
    nestedSchemas: {
      VoiceLine: [
        ...
        },
        {
          ...
          type: "string",
          required: false,
          description: "Voice style modifier.",
          defaultValue: "",
        },
        {
          name: "notes",
      ...
      PromptProfile: [
        ...
        { name: "directorNotes", type: "string", required: true, description: "Gemini Director's Notes: pacing, emotion, accent, pronunciation, delivery.", constraints: ["Must be non-empty", "Must not be placeholder text"] },
      ...
      PromptSpeaker: [
        ...
        { name: "style", type: "string", required: false, description: "Optional speaker style descriptor." },
      ],
      PromptOverride: [
        ...
        { name: "directorNotes", type: "string", required: false, description: "Optional Director's Notes override." },
    ...
    businessRules: [
      ...
      "Each prompt profile must include non-empty audioProfile, scene, directorNotes, sampleContext, and speakers.",
      ...
      "Maximum 2 speakers allowed. Additional speakers must be mapped to existing ones.",
      ...
      "Speaker IDs in lines must reference valid speakers in the speakers array.",
