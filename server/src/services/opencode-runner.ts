...
export async function runOpenCodeNormalize(
  ...
  const prompt = [
    ...
    "- High-energy battle/anger/urgent lines should prefer Fenrir or Alnilam; male elder/authority/exposition should prefer Charon, Sadaltager, Rasalgethi, or Iapetus; female formal/authoritative delivery can use Orus or Kore; young/playful lines should prefer Puck or Sadachbia; female gentle/comforting lines should prefer Achernar, Callirrhoe, or Despina; male gentle/nuanced dialogue can use Vindemiatrix; casual street dialogue should prefer Zubenelgenubi or Aoede.",
